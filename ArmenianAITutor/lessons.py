...
LESSONS = {
    ...
    "lesson_02": Lesson(
        ...
        items=[
            ...
            VocabItem("5️⃣ Five", "Հինգ", "Hink"),
            VocabItem("6️⃣ Six", "Վեց", "Vets"),
            VocabItem("7️⃣ Seven", "Եօթը", "Yot"),
            VocabItem("8️⃣ Eight", "Ութը", "Out"),
            VocabItem("9️⃣ Nine", "Ինը", "Ine"),
    ...
    "lesson_18": Lesson(
        ...
        items=[
            ...
            VocabItem("School", "Վարժարան", "Varjaran"),
            VocabItem("Church", "Եկեղեցի", "Yegeghertsi"),
    ...
    "lesson_34": Lesson(
        ...
        items=[
            ...
            VocabItem("Armenian Apostolic Church", "Հայ Առաքելական Եկեղեցի", "Hay Arakelagan Yegeghertsi"),
    ...
    "lesson_44": Lesson(
        ...
        items=[
            ...
            Sentence("The boy went to school yesterday", "Տղան երէկ դպրոց գնաց", "Dughan yereg tbrots knats", "diag_boy_school"),
            ...
            Sentence("My friend and I went to the church", "Ես ու ընկերս եկեղեցի գացինք", "Yes ou ungers yegeghetsi katsink", "diag_friend_church"),
            Sentence("He doesn't know where the school is", "Ան չի գիտեր դպրոցը ուր է", "An chi kider tbrotsuh our e", "diag_doesnt_know"),
            Sentence("Seventy-three students came to class", "Եօթանասուներեք աշակերտներ դասի եկան", "Yotanasounerek ashagerdner tasi yegan", "diag_seventy_three"),
